...
class CPT(Factor):
    ...
    def short_query_str(self, sep1=",", sep2="|"):
        ...
        return self._short_query_str(sep1, sep2, self.conditioned, self.conditioning)
    ...
    def copy(self):
        ...
        return CPT(self.values, self.states, self.conditioned, self.description)
    ...
    def from_dict(cls, d):
        ...
        return CPT(
            factor, conditioned=d.get("conditioned"), description=d.get("description")
        )
